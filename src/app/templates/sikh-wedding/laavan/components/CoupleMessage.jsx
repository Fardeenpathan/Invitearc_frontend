...
const rsvpButtonText =
  data?.coupleMessageRsvpText ||
  data?.customData?.coupleMessageRsvpText ||
  (rsvpMode === "form"
    ? "Fill RSVP Form"
  ...
  console.log("RSVP Mode:", data?.rsvpMode);
  console.log("Custom RSVP Mode:", data?.customData?.rsvpMode);
  console.log("Data:", data);

  console.log("Heading:", rsvpSectionHeading);
  console.log("Button:", rsvpButtonText);
      ...
      <div className="h-689 md:h-585 lg:h-1083 3xl:h-1367">
        ...
        <div className="relative flex flex-col items-center mt-12 md:mt-12 lg:mt-20 3xl:mt-30">
          <h2 className=" text-[#15528A] text-left text-xl md:text-4xl lg:text-[68px] 3xl:text-[78px] pl-60 md:pl-104 lg:pl-210 3xl:pl-280 md:mt-2 lg:mt-3 3xl:mt-5 flex flex-col justify-end ">
            <span className="eb-garamond font-medium">HARPREET</span>
            ...
            <span className="eb-garamond font-medium -mt-4 md:-mt-6 lg:-mt-8">
              RITIKA
            </span>
          </h2>
        ...
        <h2 className="eb-garamond font-normal text-xs md:text-xl lg:text-[32px] text-center text-[#15528A] px-4 md:px-20 lg:px-56 3xl:px-107 pt-10 md:pt-22 lg:pt-40 3xl:pt-46 mt-2 lg:mt-4 lg:leading-tight">
        ...
        {/* <div className="flex justify-center md:justify-end md:mt-2 lg:mt-135 3xl:mt-210 md:pr-5 lg:pr-10 3xl:pr-30">
          <div className="">
            <h2 className="eb-garamond font-normal text-center text-2xl md:text-3xl lg:text-[54px] text-[#15528A] pt-15 md:pt-80 lg:pt-50 3xl:pt-150 leading-normal md:leading-8 lg:leading-12">
            ...
            <div className="flex flex-col-1 md:gap-0 gap-0 lg:gap-0 justify-center items-center md:not-first:mt-4">
              <a href="#" target="_blank">
                <img
                  ...
                  alt="icon"
                  className="h-8 w-8 md:w-8 md:h-8 lg:mt-1 lg:w-10.5 lg:h-10.5 3xl:w-20 3xl:h-20"
                />
              </a>
              <h2 className="eb-garamond font-normal text-xs md:text-sm lg:text-[22px] text-[#15528A]">
                Share Your RSVP
              </h2>
            </div>
          </div>
        ...
        <div className="flex justify-center md:justify-end md:mt-2 lg:mt-135 3xl:mt-210 md:pr-5 lg:pr-10 3xl:pr-30">
          {rsvpMode === "form" ? (
            <div className="flex flex-col items-center text-center">
              <h2 className="eb-garamond font-normal text-center text-2xl md:text-3xl lg:text-[54px] text-[#15528A] pt-15 md:pt-80 lg:pt-50 3xl:pt-150 leading-normal md:leading-8 lg:leading-12 md:w-10">
                {rsvpSectionHeading}
              </h2>
            ...
            <div className="flex flex-col items-center text-center">
              <h2 className="eb-garamond font-normal text-center text-2xl md:text-3xl lg:text-[54px] text-[#15528A] pt-15 md:pt-80 lg:pt-50 3xl:pt-150 leading-normal md:leading-8 lg:leading-12 md:w-140">
                {rsvpSectionHeading}
              </h2>
